...
```{r}
#get data from PDL API

url <- "https://api.peopledatalabs.com/v5/person/enrich"

API_KEY <- "5c05369e4c54f17479afa729d59be1b2dae4149de916fea6fb8deddcbe5d7846"

query <- list("api_key" = API_KEY, "profile" = "http://linkedin.com/in/seanthorne")

res <- GET(url, query=query)

jsonresponse <- fromJSON(rawToChar(res$content))
...
```{r}
bulk_url <- "https://api.peopledatalabs.com/v5/person/enrich"

API_KEY <- "5c05369e4c54f17479afa729d59be1b2dae4149de916fea6fb8deddcbe5d7846"

headers <- list("X-Api-Key" = API_KEY, "Content-Type"="application/json")

requests <- list("linkedin.com/in/kevinyamazaki/",
...
response <- POST(bulk_url, headers=headers, json=data)
